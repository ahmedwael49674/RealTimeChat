...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue__ = __webpack_require__(33);
...
var socket = __WEBPACK_IMPORTED_MODULE_0_socket_io_client___default()('http://127.0.0.1:3000');
...
var vm = new __WEBPACK_IMPORTED_MODULE_2_vue___default.a({
    ...
    methods: {
        Broadcast: function Broadcast(friendId) {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/message/store', {
                content: this.content,
                friendId: friendId
            }).then(this.content = '');
        },
        getLastConversation: function getLastConversation() {
            var _this = this;

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/message/index').then(function (response) {
                _this.messages = response.data;
            });
            this.getFirends();
        },
        getFirends: function getFirends() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/friend/index').then(function (response) {
        ...
        getStatues: function getStatues() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/status/index').then(function (response) {
        ...
        getAuth: function getAuth() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/user/getAuth').then(function (response) {
        ...
        activeStatus: function activeStatus(statusId) {
            var _this5 = this;

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/status/update', {
                statusId: statusId
            }).then(function (response) {
                _this5.user.status_id = statusId, _this5.user.status.name = response.data, _this5.isActive = false;
            });
        },
